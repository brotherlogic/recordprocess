...
type ForceResponse struct {
	...
	Result proto1.ReleaseMetadata_Category `protobuf:"varint,1,opt,name=result,proto3,enum=recordcollection.ReleaseMetadata_Category" json:"result,omitempty"`
...
func (x *ForceResponse) GetResult() proto1.ReleaseMetadata_Category {
	if x != nil {
		return x.Result
	}
	return proto1.ReleaseMetadata_UNKNOWN
