...
type Config struct {
	...
	NextUpdateTime map[int64]int64 `protobuf:"bytes,2,rep,name=next_update_time,json=nextUpdateTime,proto3" json:"next_update_time,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *Config) GetNextUpdateTime() map[int64]int64 {
	if x != nil {
...
func (x *RecordScore) GetInstanceId() int64 {
	if x != nil {
		return x.InstanceId
	}
	return 0
...
func (x *RecordScore) GetCategory() proto.ReleaseMetadata_Category {
	if x != nil {
		return x.Category
	}
...
func (x *GetScoreRequest) GetInstanceId() int64 {
	if x != nil {
		return x.InstanceId
	}
	return 0
...
func (x *ForceRequest) GetInstanceId() int64 {
	if x != nil {
		return x.InstanceId
	}
	return 0
...
type ForceResponse struct {
	...
	Result proto.ReleaseMetadata_Category `protobuf:"varint,1,opt,name=result,proto3,enum=recordcollection.ReleaseMetadata_Category" json:"result,omitempty"`
...
func (x *ForceResponse) GetResult() proto.ReleaseMetadata_Category {
	if x != nil {
		return x.Result
	}
	return proto.ReleaseMetadata_Category(0)
...
func (x *GetRequest) GetInstanceId() int64 {
	if x != nil {
		return x.InstanceId
	}
	return 0
...
var file_recordprocess_proto_rawDesc = []byte{
	...
	0x22, 0x6b, 0x0a, 0x0d, 0x46, 0x6f, 0x72, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
...
var file_recordprocess_proto_goTypes = []interface{}{
	...
	(proto.ReleaseMetadata_Category)(0), // 10: recordcollection.ReleaseMetadata.Category
}
